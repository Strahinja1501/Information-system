...
Public Class Klime
    ...
    Public Sub load_data()
        ...
        Dim Sql As String = "Select * FROM ARTIKLI WHERE IME_KLIME <> ''"
        'Dim Sql As String = "SELECT ID_ARTIKLA, IME_KLIME, SERIJSKI_BROJ_KLIME, COUNT(*) AS STANJE_U_MAGACINU FROM ARTIKLI WHERE SERIJSKI_BROJ_KLIME <>'' GROUP BY IME_KLIME, SERIJSKI_BROJ_KLIME, ID_ARTIKLA ORDER BY IME_KLIME, SERIJSKI_BROJ_KLIME"
        ...
        DataGridView1.Columns("STANJE").HeaderText = "NA STANJU"
    ...
    'START________________________________________________________________________________________________
    ...
    Private Sub Button5_Click_1(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Dim sqlQuery As String = "SELECT * FROM ARTIKLI WHERE (IME_KLIME LIKE '%' + @searchTerm + '%' OR IME_DELA LIKE '%' + @searchTerm + '%') AND IME_KLIME <> ''"
